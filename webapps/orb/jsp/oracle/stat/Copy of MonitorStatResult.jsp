...
<%
	...
	while(colNames.hasMoreElements()) {
		String inStr = 	(String)colNames.nextElement();

		// @@@
		if (!inStr.equals("statName"))
			colName = inStr;
	}
...
System.out.println(colName);
	...
	//
	double X_INCREMENT = 6.333;

	double y = 0.0;
	double yMax = -2147483647;
...
// @@@@
		//Vector valueVect = (Vector) t.getVect(sid, "MON_LATCH", statName, "GETS");
		Vector valueVect = (Vector) t.getVect(sid, "MON_LIBRARYCACHE", statName, colName);
...
//System.out.println(i + " " + valueVect.elementAt(i));
