...
//					System.out.println("|" + tmpStr+ "+");
					...
					// successfully logged in @@@ (how about linux???)
					if (tmpStr.indexOf("Last login") != -1) {

						return true;
					}

					if (tmpStr.indexOf("Login incorrect") != -1) {
						String message = "Login incorrect! host: " + host + " by login: " + username;
						SysLog log = new SysLog();
						log.write(CLASSNAME, METHODNAME,
									SysLog.ML_SEVERE,
									null,
