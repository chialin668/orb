...
public class TelnetClient0 {
    public static void main (String[] av) {
		...
		new TelnetClient0(System.in, System.out, host, port);
    }
//////////////////////////////////////////////////////////////////////////////

    public TelnetClient0 (InputStream in, PrintStream out,
	...
	try {
	    ...
	    System.out.println("TelnetClient0: Got exception during connect: " + e);
	    e.printStackTrace();
	}
	...
	try {
	    ...
	    System.out.println("TelnetClient0: Got exception in read/write loop: " + e);
	    e.printStackTrace();
	    return;
	} finally {
	    try {
		...
		System.out.println("TelnetClient0: got exception in disconnect: " + e);
		e.printStackTrace();
	    }
	}
}
