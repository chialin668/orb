...
public class Database {
	...
	public boolean init(String sqlTag) {
		...
		cio = new CheckInOut();
		conn = cio.checkOut("ORACLE", machine, sid, username, password);
		if (conn == null) {
...
//			conn.close();
			...
			if (!cio.checkIn("ORACLE", sid, conn)) {
	...
	**/
	...
	public static void main(String args[]) {
		...
		System.out.println("----->" + System.currentTimeMillis()/1000);
		Database o1 = new Database("172.16.1.20", "1521", "system", "systempass", "DGTL");

		o1.executeSQL("DB_VERSION");
		System.out.println(o1.getHeaderStr());
		System.out.println(o1.getDataStr());


		System.out.println("----->" + System.currentTimeMillis()/1000);
		Database o2 = new Database("172.16.1.20", "1521", "system", "systempass", "DGTL");

		o2.executeSQL("DB_VERSION");
		System.out.println(o2.getHeaderStr());
		System.out.println(o2.getDataStr());
	}
