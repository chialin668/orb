...
genOutput(out, "</table>\n");
String domStr = "<SCRIPT LANGUAGE=\"JavaScript\">\n"
		+ "var row;\n"
		+ "var cell;\n"
		+ "var tbody = " + sqlTag + ".childNodes[0];\n";
genOutput(out, domStr);
...
domStr = "  row = document.createElement( \"TR\" );\n"
...
//								+  nextData + "</p></td>\n");
						domStr = "cell = document.createElement(\"TD\");\n"
						   			+ "row.appendChild( cell );\n"
    								+ "cell.innerText = '" + nextData + "';\n";
						genOutput(out, domStr);
