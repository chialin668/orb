...
<head>
	...
	<META HTTP-EQUIV="refresh" content="5;
		URL=http:/orb/jsp/sys/SarGraph.jsp?machine=<%=unix%>&load=null">
	</META>	
...
<v:group style="height=200pt; width=400pt" coordsize="4000,2000"></div>
...
<%
	...
	idleStr = new Long(xCord).toString() + " " + new Long(yCord).toString() + " ";
%>

<FORM NAME=form1>
	<INPUT type=hidden NAME=idleTxt value="<%=idleStr%>">
<BR>
</FORM>

<SCRIPT LANGUAGE=JavaScript>
		
	var inStr = window.parent.frames["SarData"].document.form1.idleTxt.value;
	var outStr = inStr + document.form1.idleTxt.value;
	window.parent.frames["SarData"].document.form1.idleTxt.value = outStr;
	
	var lineStr = "<v:polyline points=\"" + outStr + "\""
